    ...
    MediumEditor.prototype = {
        ...
        initElements: function () {
            ...
            for (i = 0; i < this.elements.length; i += 1) {
                ...
                this.bindParagraphCreation(i).bindReturn(i).bindTab(i).bindBackspace(i);
        ...
        imageOrientation: function(el) {
            var width = jQuery(el).width();    // Current image width
            var height = jQuery(el).height();  // Current image height
            ...
            jQuery(el).find('img.unprocessed').each(function(e){
                ...
                if (orientation == 'landscape') {
                    ...
                    switch(col) {
                        ...
                        break;
                        case 2:
                                data.zero = image_array[image_id].ppm_l3[0];
        ...
        serialize: function () {
            var i,
                ...
                jQuery(temp.elements).find('.drop').each(function() {
                    jQuery(this).remove();
                });

                jQuery(temp.elements).find('.canvas .row-holder').each(function() {
                    var colus = jQuery(this).data('colus');
                    var image_size = '';
            ...
            for (i = 0; i < temp.elements.length; i += 1) {
                elementid = (temp.elements[i].id !== '') ? temp.elements[i].id : 'element-' + i;
                content[elementid] = {
                    value: temp.elements[i].innerHTML.trim()
                };
            }
            return content;
        },
        ...
        bindParagraphCreation: function (index) {
            ...
            this.elements[index].addEventListener('keypress', function (e) {
                ...
                if (e.which === 32) { // detect space
                    tagName = node.tagName.toLowerCase();
                    console.log(tagName);
                    if (tagName === 'a') { //unlink if tag was link
